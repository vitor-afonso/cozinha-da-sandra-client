  ...
  return (
    <>
      <Helmet>
        ...
        <link rel='canonical' href={pagesRoutes.signup} />
      </Helmet>
      <Box sx={signupClasses.container}>
        <Box sx={signupClasses.top}>
          ...
          <Box sx={{ alignSelf: { md: 'start' }, ml: { md: 6 } }}>
            <Typography variant={componentProps.variant.h4} sx={{ marginTop: { xs: 2 } }} color={theme.palette.neutral.main} component={componentProps.variant.h1}>
              Registrar
            </Typography>
